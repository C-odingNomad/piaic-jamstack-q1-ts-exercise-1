...
while(guestList.length > 2) {
    ...
    console.log(`Dear ${removeGuest}, we are very sorry to inform you that due to the unexpected delay in the delievery of our dinner table, we won't able to serve all and you're one of them.`)
}
guestList.map((item) => {
